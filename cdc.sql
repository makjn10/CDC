...
-- Dumping database structure for cdc_db
CREATE DATABASE IF NOT EXISTS `cdc_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cdc_db`;

-- Dumping structure for table cdc_db.cbcs_branches
...
-- Dumping data for table cdc_db.cbcs_branches: ~64 rows (approximately)
...
-- Dumping structure for table cdc_db.cbcs_departments
...
-- Dumping data for table cdc_db.cbcs_departments: ~51 rows (approximately)
...
-- Dumping structure for table cdc_db.courses
...
-- Dumping data for table cdc_db.courses: ~17 rows (approximately)
...
-- Dumping structure for table cdc_db.departments
...
-- Dumping data for table cdc_db.departments: ~55 rows (approximately)
...
-- Dumping structure for table cdc_db.infeligiblebranches
CREATE TABLE IF NOT EXISTS `infeligiblebranches` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `companyID` int(11) DEFAULT NULL,
  `Computer Science and Engineering` tinyint(1) DEFAULT NULL,
  `Electronics and Communication Engineering` tinyint(1) DEFAULT NULL,
  `Electrical Engineering` tinyint(1) DEFAULT NULL,
  `Mechanical Engineering` tinyint(1) DEFAULT NULL,
  `Civil Engineering` tinyint(1) DEFAULT NULL,
  `Chemical Engineering` tinyint(1) DEFAULT NULL,
  `Mining Engineering` tinyint(1) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `infgpas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `companyID` int(11) DEFAULT NULL,
  `Bachelor of Technology` int(11) DEFAULT NULL,
  `Dual Degree` int(11) DEFAULT NULL,
  `Master of Technology` int(11) DEFAULT NULL,
  `Integrated Master of Technology` int(11) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `infs` (
  ...
  `companyCategory` text DEFAULT NULL,
  `companyWebsite` text DEFAULT NULL,
  `jobDesignation` text DEFAULT NULL,
...
-- Dumping data for table cdc_db.users: ~2 rows (approximately)
...
-- Dumping structure for table cdc_db.user_auth_types
...
-- Dumping data for table cdc_db.user_auth_types: ~826 rows (approximately)
...
-- Dumping structure for table cdc_db.user_details
...
-- Dumping data for table cdc_db.user_details: ~2 rows (approximately)
